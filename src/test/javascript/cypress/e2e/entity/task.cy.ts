...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('百般');
      cy.get(`[data-cy="title"]`).should('have.value', '百般');

      cy.get(`[data-cy="description"]`).type('统统');
      cy.get(`[data-cy="description"]`).should('have.value', '统统');
