...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('语堂');
      cy.get(`[data-cy="firstName"]`).should('have.value', '语堂');

      cy.get(`[data-cy="lastName"]`).type('蒉');
      cy.get(`[data-cy="lastName"]`).should('have.value', '蒉');

      cy.get(`[data-cy="email"]`).type('kutqrx39@hotmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'kutqrx39@hotmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('yippee now modeling');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'yippee now modeling');

      cy.get(`[data-cy="hireDate"]`).type('2024-02-22T11:54');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2024-02-22T11:54');

      cy.get(`[data-cy="salary"]`).type('4623');
      cy.get(`[data-cy="salary"]`).should('have.value', '4623');

      cy.get(`[data-cy="commissionPct"]`).type('26158');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '26158');
