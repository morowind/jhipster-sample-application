...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('International Branding Technician');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'International Branding Technician');

      cy.get(`[data-cy="minSalary"]`).type('30239');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '30239');

      cy.get(`[data-cy="maxSalary"]`).type('8933');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '8933');
